                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IEX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iex: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zIEX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IEX Core"), this);
    aboutAction->setStatusTip(tr("Show information about IEX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IEX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a IEX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IEX Core help message to get a list with possible IEX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IEX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IEX network", "", count));
}
...
{
    QString strTitle = tr("IEX Core"); // default title
...
/** Creates context menu, its actions, and iexs up all the relevant signals for mouse events. */
