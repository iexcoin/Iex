...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IEX features */
        {"iex", "masternode", &masternode, true, true, false},
        {"iex", "listmasternodes", &listmasternodes, true, true, false},
        {"iex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"iex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"iex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"iex", "masternodedebug", &masternodedebug, true, true, false},
        {"iex", "startmasternode", &startmasternode, true, true, false},
        {"iex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"iex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"iex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"iex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"iex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"iex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"iex", "mnbudget", &mnbudget, true, true, false},
        {"iex", "preparebudget", &preparebudget, true, true, false},
        {"iex", "submitbudget", &submitbudget, true, true, false},
        {"iex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"iex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"iex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"iex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"iex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"iex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"iex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"iex", "checkbudgets", &checkbudgets, true, true, false},
        {"iex", "mnsync", &mnsync, true, true, false},
        {"iex", "spork", &spork, true, true, false},
        {"iex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"iex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use iexd, or the -server option to iex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> iex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14321/\n";
}
