...
In order to support loading of multiple wallets in iex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is iex.cpp.
...
Changes to iex.cpp
----------------------
iex.cpp is the entry point into iex-qt, and as such, will require some minor modifications to provide hooks for
