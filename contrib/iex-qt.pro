...
RESOURCES += src/qt/iex.qrc src/qt/iex_locale.qrc

TRANSLATIONS += src/qt/locale/iex_bg.ts \
                src/qt/locale/iex_de.ts \
                src/qt/locale/iex_en.ts \
                src/qt/locale/iex_es.ts \
                src/qt/locale/iex_fi.ts \
                src/qt/locale/iex_fr.ts \
                src/qt/locale/iex_it.ts \
                src/qt/locale/iex_ja.ts \
                src/qt/locale/iex_pl.ts \
                src/qt/locale/iex_pt.ts \
                src/qt/locale/iex_ru.ts \
                src/qt/locale/iex_sk.ts \
                src/qt/locale/iex_sv.ts \
                src/qt/locale/iex_vi.ts \
                src/qt/locale/iex_zh_CN.ts \
                src/qt/locale/iex_zh_TW.ts
