...
This means one can have an always-on iexd instance running, and another local iexd/iex-qt instance which connects to this node and receives blocks from it.
