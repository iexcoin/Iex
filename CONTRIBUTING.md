Contributing to IEX Core
============================

The IEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IEX Core project, and is not to be
confused with overall IEX Network Protocol consensus changes.

Whether a pull request is merged into IEX Core rests with the project merge
...
Patches that change IEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the IEX consensus, it must have been
...
The project leader is the release manager for each IEX Core release.
